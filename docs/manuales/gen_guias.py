...
GUIAS["Guia_Solicitudes"] = Guia(
    "Actividades de Marketing & Research", "5.1", "14/09/2026",
    ...
    [
        ...
        ("Comentarios (Información General)", "Qué ingresar: opcional. Cualquier aclaración adicional para Marketing & Research. En el último paso hay además una caja de comentarios finales, también opcional."),
        ("Ejecutivo(s) Comercial(es) a cargo", "Qué ingresar: opcional. Quién o quiénes están a cargo comercialmente de esta Ficha/Publicación."),
        ...
        ("Disponibilidad", "Muestra los pisos elegidos en Información General → Inmueble Asociado → Componentes, con sus datos precargados: m², tipo de operación, asking rent y propietario. Esos datos se pueden editar acá mismo, puntualmente para esta Ficha/Publicación: el cambio no modifica el inmueble ni sus componentes originales. No se pueden agregar ni quitar pisos desde acá — para eso está el botón 'Modificar selección', que vuelve a Información General."),
        ("Mínimo divisible", "Se completa con el dato del inmueble cuando está cargado; se puede editar para esta Ficha/Publicación sin modificar el inmueble."),
        ("Resumen de disponibilidad", "Se calcula solo a partir de los datos de Disponibilidad (ya con las ediciones puntuales aplicadas): va del piso más chico a la suma de todos los seleccionados. Por ejemplo, dos pisos de 986 m² dan '986 – 1.972 m²'; si se edita uno a 1.200 m², el resumen se recalcula solo. Es editable por si hace falta ajustarlo a mano."),
        ("Características (Publicación)", "Paso final de datos de la Publicación. Agrupa, entre otras, la sección 'Características de la publicación' con las Superficies y Dimensiones (superficie total, cubierta, propia, cocheras y baños — la total debe ser mayor o igual a la cubierta), la Distribución de la Unidad, las Características Particulares y el Equipamiento y Servicios."),
